                ...
                {(!isRawPgnMode && (history.length > 0 || redoStack.length > 0)) ? (
                  ...
                  <div className="flex flex-col gap-1 w-full flex-1">
                    ...
                    <span className="text-[10px] font-sans text-zinc-400 dark:text-zinc-500 mt-0.5 ml-1 leading-snug">
                        PGNs must include move timestamps (<span className="font-mono">[%clk]</span> tags) to be rated. Please allow ~15 seconds for the model to load on your first prediction.
                    </span>
                  </div>
                )}
